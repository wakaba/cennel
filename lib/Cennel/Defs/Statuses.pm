...
sub OPERATION_UNIT_STATUS_REVERTED { 7 }
...
our $StatusCodeToText = {
    OPERATION_UNIT_STATUS_INITIAL, 'initial',
    OPERATION_UNIT_STATUS_STARTED, 'started',
    OPERATION_UNIT_STATUS_FAILED, 'failed',
    OPERATION_UNIT_STATUS_SUCCEEDED, 'succeeded',
    OPERATION_UNIT_STATUS_PRECONDITION_FAILED, 'precondition-failed',
    OPERATION_UNIT_STATUS_SKIPPED, 'skipped',
    OPERATION_UNIT_STATUS_REVERTED, 'reverted',
};
