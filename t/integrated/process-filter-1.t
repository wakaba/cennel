...
test {
    ...
    'cennel.filter.repository_urls' => 'hoge,fuga',
}), name => 'url no match', n => 4;
...
test {
    ...
    'cennel.filter.repository_urls' => 'hoge,fuga',
}), name => 'url no match, empty', n => 4;

my $repo0_d = create_git_repository;
test {
    my $c = shift;
    my $data = $c->received_data;
    ...
    'cennel.filter.repository_urls' => $repo0_d->stringify,
}), name => 'url match', n => 4;
